 ...
 */
@Stateless
@Path("com.nino.app.hrishiring.contact")
public class ContactFacadeREST extends AbstractFacade<Contact> {
    ...
    private ContactPK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;idcontact=idcontactValue;personidPerson=personidPersonValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        com.nino.app.hrishiring.ContactPK key = new com.nino.app.hrishiring.ContactPK();
        javax.ws.rs.core.MultivaluedMap<String, String> map = pathSegment.getMatrixParameters();
        java.util.List<String> idcontact = map.get("idcontact");
        if (idcontact != null && !idcontact.isEmpty()) {
            key.setIdcontact(new java.lang.Integer(idcontact.get(0)));
        }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Contact entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.nino.app.hrishiring.ContactPK key = getPrimaryKey(id);
    ...
    public Contact find(@PathParam("id") PathSegment id) {
        com.nino.app.hrishiring.ContactPK key = getPrimaryKey(id);
